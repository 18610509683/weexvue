...
export function fetchAllCategory(data) {
  return request({
    url: modelHeader + '/CookManage/getAllCategory',
    method: 'post',
    data
  })
}
...
// 获取所有关联分类
export function getRelationFoodCategory(data) {
  return request({
    url: modelHeader + '/FoodManage/getRelationFoodCategory',
    method: 'post',
    data
  })
}
...
export function delFoodType(data) {
  return request({
    url: modelHeader + '/FoodManage/deleteCategory',
    method: 'post',
    data
  })
}
...
export function updateFoodType(data) {
  return request({
    url: modelHeader + '/FoodManage/updateCategory',
    method: 'post',
    data
  })
}
...
export function updateFoodTypeStatus(data) {
  return request({
    url: modelHeader + '/FoodManage/upCategoryStatus',
    method: 'post',
    data
  })
}
