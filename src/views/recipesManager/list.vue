      ...
      <div class="filter-container">
        <el-row>
          ...
          <el-col class="filter-item" :xs="12" :sm="8" :lg="6">
            ...
            <el-select class="filter-input" size="small" v-model="listQuery.suitablePeople" placeholder="适宜人群"
                       clearable>
...
<!--            </el-button>-->
      ...
      <el-table v-loading="listLoading" :data="list" @sort-change="sortChange" border fit highlight-current-row
                style="width: 100%;">
