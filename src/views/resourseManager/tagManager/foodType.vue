  ...
  <div class="app-container garbage-con">
    ...
    >
      ...
      >
        ...
        <el-form-item label="子级分类" prop="alias">
...
<script>
import { fetchFoodType, fetchCascadeFoodType, insertFoodType, delFoodType, updateFoodType, fetchAllFoodType, updateFoodTypeStatus} from "@/api/foodManager";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      fetchFoodType(this.listQuery).then(res => {
