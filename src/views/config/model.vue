  ...
  <div class="app-container garbage-con">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column label="模块名称" align="center" width="150">
          <template slot-scope="{row}">
            <span>{{ row.cname }}</span>
          </template>
        </el-table-column>
        <el-table-column label="别名" align="center" width="150">
          <template slot-scope="{row}">
            <span>{{ row.alias }}</span>
          </template>
        </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="页面名称" prop="cname" >
